...
async function generateSlides(config) {
  ...
  console.log(`🤖 Generating slides using ${provider}/${model}...`);
...
`;
    ...
    console.error(`❌ Error generating slides with ${provider}:`, error.message);
...
async function generateSampleSlides(config) {
  ...
  console.log(`🧪 TEST MODE: Generating sample slides for: ${topic}`);
